...
class GenerationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create generation" do
    assert_difference("Generation.count") do
      post generations_url, params: { generation: { name: @generation.name, region: @generation.region } }
    end
  ...
  test "should update generation" do
    patch generation_url(@generation), params: { generation: { name: @generation.name, region: @generation.region } }
